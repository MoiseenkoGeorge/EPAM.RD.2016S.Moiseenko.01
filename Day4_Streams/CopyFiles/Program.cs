...
namespace FileStreams
{
    public class Program
    {
        ...
        public static void MemoryBufferCopy(string source, string destin)
        {
            ...
            using (var destinStream = new FileStream(destin, FileMode.Create, FileAccess.Write))
            {
                using (var textReader = (TextReader) new StreamReader(sourceStream)) 
                {
            ...
            using (var destinStream = new FileStream(destin, FileMode.Create))
            {
                ...
                do
                {
                    bytesRead = stringReader.ReadBlock(buffer, 0, buffer.Length); 
                ...
                destinStream.Write(buf, 0, buf.Length);
            }

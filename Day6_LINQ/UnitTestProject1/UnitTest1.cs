...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void ContainOrNotContainName()
        {
            ...
            //name max 
            isContain = userListSecond.Any(u => u.Name == "Max");
        ...
        public void GetMaxSalaryFromFirst()
        {
            ...
            actualData = userListFirst.OrderByDescending(u => u.Salary).ToArray()[0];
        ...
        public void GetCountUserWithNameMaxFromSecond()
        {
            ...
            actualData = userListSecond.Where(u => u.Name == "Max").ToList().Count;
        ...
        public void Join()
        {
            ...
            actualData = userListSecond.Join(NameInfo, u => u.Name, a => a.name, (u, a) => new
            {
                Name = u.Name,
                Info = a.Info,
                Age = u.Age,
